<template>
  <el-scrollbar style="height:100%">
    <div class="tech_term_box">
      <div class="tech_term_right">
        <div class="flex" style="justify-content: flex-end;border-bottom:1px solid #dee2e6;padding-bottom: 7px;box-sizing: border-box;">
          <div class="collect"><i class="el-icon-circle-plus" />申请</div>
          <div class="collect"><i class="el-icon-edit"/>变更申请</div>
          <div class="collect"><i class="el-icon-delete"/>废止</div>
        </div>
        <div class="toolbar" style="text-align:left;padding-top:10px;">
          <el-form :inline="true" size="small">
            <div class="flex">
              <el-form-item>
                <el-select size="small" v-model="std_item_grp_nm" placeholder="请选择标准分类" ref="selectReport" clearable>
                  <el-option style="height: auto" :value="std_item_grp_nm" :label="std_item_grp_nm">
              ...
              <el-form-item>
                <el-select size="small" v-model="std_item_grp_nm1" placeholder="请选择标准分类" ref="selectReport1" clearable>
                  <el-option style="height: auto" :value="std_item_grp_nm1" :label="std_item_grp_nm1">
                    <el-tree :data="tree1" :props="defaultProps" @node-click="handleNodeClick1" ref="tree1"
                      :render-content="renderContent" :filter-node-method="filterNode">
                    </el-tree>
                  </el-option>
                </el-select>
          ...
          <el-table :data="tableTreeDdata" border stripe size="mini" style="width: 100%;" rowKey="id"
            ...
            <el-table-column prop="std_item_grp1" label="标准主题" min-width="70" :show-overflow-tooltip='true'>
            </el-table-column>
            <el-table-column prop="std_item_grp2" label="标准大类" min-width="70" :show-overflow-tooltip='true'>
            </el-table-column>
            <el-table-column prop="std_item_grp3" label="标准子类" min-width="70" :show-overflow-tooltip='true'>
            </el-table-column>
            <el-table-column prop="std_item_grp4" label="标准细类" min-width="70" :show-overflow-tooltip='true'>
            </el-table-column>
            <el-table-column prop="std_item_chn_nm" label="标准中文名" min-width="115" :show-overflow-tooltip='true'>
            ...
            <el-table-column prop="std_item_eng_nm" label="标准英文名称" min-width="130" :show-overflow-tooltip='true'>
            </el-table-column>
            <el-table-column prop="biz_dttyp_nm" label="数据类型" min-width="80" :show-overflow-tooltip='true'>
            </el-table-column>
            <el-table-column prop="dt_len" label="长度" width="50" :show-overflow-tooltip='true'>
            </el-table-column>
            <el-table-column prop="prcsn" label="精度" width="50" :show-overflow-tooltip='true'>
            </el-table-column>
            <el-table-column prop="biz_mean" label="业务含义" min-width="220" :show-overflow-tooltip='true'>
            </el-table-column>
            <el-table-column prop="rles_vrsn" label="版本号" :show-overflow-tooltip='true'>
            </el-table-column>
            <el-table-column prop="rles_tm_format" label="版本日期" :formatter="dateFormat" min-width="130" :show-overflow-tooltip='true'>
            </el-table-column>
            <el-table-column prop="std_item_chn_nm" label="状态" min-width="80" :show-overflow-tooltip='true'>
              <template slot-scope="scope">
                <div style="color: #0072E3;cursor:pointer">
                  {{scope.row.stat}}
                </div>
              </template>
            </el-table-column>
...
<script>
  ...
  import TechTermDialog from './TechTermDialog.vue'
  import {
    format
  } from "@/utils/datetime"
  export default {
    ...
    data() {
      return {
        ...
        std_item_grp_nm: '',//菜单树选中
        std_item_grp_nm1:'',//菜单树选中
        val: '',
        options: [{
          value: '',
          label: '全部'
    ...
    methods: {
      ...
      //树菜单点击事件
      handleNodeClick(e) {
        this.std_item_grp_nm = e.std_item_grp_nm
        let id = e.std_item_grp_id
          this.params.std_item_grp_id = id
          this.contReq.std_item_grp_id = id
        this.findPage()
      },
      handleNodeClick1(e){
        this.std_item_grp_nm1 = e.std_item_grp_nm
        let id = e.dept_id
