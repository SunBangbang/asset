  ...
  export default {
    ...
    methods:{
      ...
      async standardBasicInformationReq(){
        ...
        let {data: res} = await this.$api.util.execAction(params)
        // if (!res.info) res.info = standardBasicInformation.info
      ...
      async codeValListReq(pagelimit){
        ...
        params = {...params,...this.pagelimit}
        let {data: res} = await this.$api.util.execAction(params)
        // if (!res.codeValList) res.codeValList = codeValList.codeValList
      ...
      async ReferDetailsReq(){
        ...
        params = {...params,...this.pagelimit1}
        let res = await this.$api.util.execAction(params)
        // if (!res.data.length) res.data = ReferDetails
