  ...
  <div class="headbar" :style="{'background':themeColor}"
    ...
    <span class="navbar">
      <el-menu :default-active="activeIndex" class="el-menu-demo" :background-color="themeColor" text-color="#fff"
        ...
        <el-menu-item index="1" @click="changeNavBar(Sys)"><i class="fa fa-home fa-lg"></i> </el-menu-item>
        <!-- <el-menu-item index="2" @click="changeNavBar(Sys2)">系统管理</el-menu-item> -->
  ...
  export default {
    ...
    methods: {
      async changeNavBar(item) {
        ...
        let {
          data: res
        } = await this.$api.menu.findNavTree({
          'userName': userName
        })
